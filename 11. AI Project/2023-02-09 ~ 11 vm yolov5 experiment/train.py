...
def parse_opt(known=False):
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/data_birds_o.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--name', default='2023-02-09-2nd', help='save to project/name')
